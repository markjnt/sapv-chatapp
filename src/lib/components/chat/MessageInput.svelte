<script lang="ts">
	...
	const activeIntegrationButtonClass =
		'text-[rgb(194,41,105)] dark:text-[rgb(230,130,170)] bg-[rgb(194,41,105)]/10 hover:bg-[rgb(194,41,105)]/15 dark:bg-[rgb(194,41,105)]/10 dark:hover:bg-[rgb(194,41,105)]/20 border border-[rgb(194,41,105)]/25 dark:border-[rgb(194,41,105)]/30';
					...
					>
						...
						<div
							...
							class="flex-1 flex flex-col relative w-full shadow-lg rounded-3xl border {$temporaryChatEnabled
								...
								: ' border-[rgb(77,40,103)]'}  transition px-1 bg-white/5 dark:bg-gray-500/5 backdrop-blur-sm dark:text-gray-100"
										...
										{#if prompt === '' && files.length === 0 && ($_user?.role === 'admin' || ($_user?.permissions?.chat?.call ?? true))}
											<div class=" flex items-center">
												...
												<Tooltip content={$i18n.t('Voice mode')}>
													<button
														class="bg-[rgb(194,41,105)] text-white hover:bg-[rgb(170,36,92)] transition rounded-full p-1.5 self-center"
														type="button"
														on:click={async () => {
												...
												>
													<button
														...
														class="{!(prompt === '' && files.length === 0) || uploadPending
															? 'bg-[rgb(194,41,105)] text-white hover:bg-[rgb(170,36,92)] '
